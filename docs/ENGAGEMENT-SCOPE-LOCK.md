...
- **S3 — guided loop on engagement (UI + wiring)** — in progress.
- **S4 — never-auto-run-in-loop lock + honest UI text** — in progress (enforcement + test already in place; honest banner text pending).
- **S5 — test consolidation** — largely in place (see above); final pass pending.
