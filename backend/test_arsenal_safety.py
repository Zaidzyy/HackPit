...
_ARGUMENT_DEPENDENT = frozenset({"certipy", "certipy-ad", "certify", "Certify.exe",
                                 ...
                                 # attacks. Textbook shape for this bucket — the bare binary must
                                 # stay clean, and the -quickurl template fires.
                                 # NOTE: `-autorun plan.yaml` would hide its own aggression
                                 # inside the plan file, which is why the catalog ships no
                                 # autorun template — see §4 of the design spec.
                                 "zaproxy", "zap", "owasp-zap"})
